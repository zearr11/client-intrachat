...
import { CampaignEspecialResponse } from '../../interfaces/campaign.interface';
...
import { CampaignChangeStateComponent } from '../../components/campaign-change-state/campaign-change-state.component';
...
export class CampaignPageComponent {
  ...
  /* Data paginada */
  dataPaginated = signal<PaginatedResponse<CampaignEspecialResponse> | null>(
    null
  );
  ...
  @ViewChild('modalNew') modalNew!: CampaignAddComponent;
  @ViewChild('modalEdit') modalEdit!: CampaignEditComponent;
