...
import { UserChangeStateComponent } from '../../components/user-change-state/user-change-state.component';
...
export class UserPageComponent {
  ...
  changeState(number: string) {
    if (number == '1') this.showActives.set(true);
    else this.showActives.set(false);
  ...
  @ViewChild('modalInfoUser') modalInfoUser!: UserInfoComponent;
  @ViewChild('modalNewUser') modalNewUser!: UserAddComponent;
  @ViewChild('modalEditUser') modalEditUser!: UserEditComponent;
  @ViewChild('modalChangeStateUser')
  modalChangeStateUser!: UserChangeStateComponent;
